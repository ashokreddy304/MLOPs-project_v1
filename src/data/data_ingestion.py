...
def main():
    try:
        ...
        df = load_data(data_url='https://raw.githubusercontent.com/ashokreddy304/MLOPs-project_v1/refs/heads/main/notebooks/data.csv')
        
        # s3 = s3_connection.s3_operations("mlops-v1-a", 
        #                                  "AKIAVZ67FZ6P5R3JNS", 
        #                                  "AwunM6jpwXQ4lVqgjznB2h7oQJxL/AKR4KIGB")
